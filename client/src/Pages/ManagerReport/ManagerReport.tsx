    ...
    <>
      <div className="m-4 grid grid-cols-1 md:grid-cols-4 row-gap-4 col-gap-4">
        ...
        <div className="flex flex-col justify-center items-center col-span-1 bg-white p-6 shadow-lg hover:shadow-none cursor-pointer transition-all duration-300 ease-in border-b-4 border-opacity-0 hover:border-opacity-100 border-orange-200">
          <div className="bg-pink-200 p-2 cursor-pointer rounded-full">
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
      ...
      {/* <div className="containerr">
        ...
        >
          <div className="report-item">
            ...
            >
              <p style={{ color: "#C81E1E" }}>TOTAL CUSTOMERS</p>{" "}
              <p>200 CUSTOMERS</p>
            </div>
          </div>
          <div className="report-item">
            ...
            >
              <p style={{ color: "#C81E1E" }}>GROSS PRODUCT</p> <p>Product </p>
            </div>
          </div>
          <div className="report-item">
            <BsFillCartCheckFill
            ...
            >
              <p style={{ color: "#C81E1E" }}>TOTAL ORDER</p> <p>200 Orders</p>
            </div>
          </div>
          <div className="report-item">
            <BiSolidTagX
            ...
            >
              <p style={{ color: "#C81E1E" }}>PRODUCT IS OUT OF STOCK</p>{" "}
              <p>4 products</p>
            </div>
          </div>
          <div className="report-item">
            ...
            >
              <p style={{ color: "#C81E1E" }}>Blocked</p> <p>3 customers</p>
            </div>
          </div>
          <div className="report-item">
            <TbReportOff
            ...
            >
              <p style={{ color: "#C81E1E" }}>ORDER CANCELED</p> <p>4 orders</p>
            </div>
          </div>
        </section>
